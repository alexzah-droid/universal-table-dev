...
- Импорт данных из **XLSX** (roundtrip: экспорт → редактирование в Excel → импорт обратно). **Внимание:** импорт полностью заменяет все текущие данные на содержимое файла
